...
.PHONY: recurse
recurse:
	$(if $(DRY_RUNNING),,@)$(if $(SHOULD_NOT_FILTER_OUTPUT),,ruby $(SALMA_HAYEK)/filter-build-output.rb) $(MAKE) $(if $(DRY_RUNNING),-n) $(MAKECMDGOALS) -f $(SALMA_HAYEK)/universal.make
